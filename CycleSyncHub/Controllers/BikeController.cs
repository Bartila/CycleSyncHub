...
using CycleSyncHub.Application.BikeInfo.Commands.CreateInfo;
...
public class BikeController : Controller
{
    ...
    public BikeController(IMediator mediator, IMapper mapper, CycleSyncHub.Application.ApplicationUser.IUserContext user, CycleSyncHub.Application.ApplicationUser.IUserContext userContext)
    {
        _mediator = mediator;
        _mapper = mapper;
...
*/
    ...
    [HttpGet]
    [Authorize(Roles = "Admin")]
    [Route("ApplicationUser/CurrentUsers")]
    ...
    [HttpPost]
    [Authorize(Roles = "Admin")]
    [Route("ApplicationUser/DeleteUsers")]
    public async Task<IActionResult> DeleteUsers(string userId)
    {
        ...
        await _userContext.DeleteUsers(userId);
